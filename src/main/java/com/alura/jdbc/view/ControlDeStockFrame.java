    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    Integer cantidad = Integer.valueOf(
                    		modelo.getValueAt(tabla.getSelectedRow(), 3).toString());
                    int filasModificada = this.productoController.modificar(
                    		nombre, descripcion, cantidad, id);
					
					JOptionPane.showMessageDialog(this, String.format(
							"%d Item eliminado con éxito!", filasModificada));
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    JOptionPane.showMessageDialog(this, cantidadEliminada 
